...
export default function FilialInfo ({ nome, id, cep, numero, complemento }) {
    ...
    return <>
        {/* MODAL EXIBIÇÃO - Exibir informações da filial */}
        <div className="modal fade" id={`modalfilial-${id}`} tabIndex="-1" aria-labelledby="modalImagemLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">

                    {/* CABEÇALHO */}
                    <div className="modal-header fundoPreto">
                        <h5 className="modal-title" id="modalImagemLabel">Filial - {nome}</h5>
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-2" onClick={modalAtualizar}>Atualizar</button>
